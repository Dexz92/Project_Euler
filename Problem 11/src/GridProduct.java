...
public class GridProduct {
	...
	public int calculateRightDiagonal(){
		for(int row = 0; row < 17; row++){
			for(int col = 0; col < 17; col++){
				...
				if(product > rightDiagonal){
					rightDiagonal = product;
				}
			}
		}
	...
	public int calculateLeftDiagonal(){
		for(int row = 0; row < 17; row++){
			for(int col = 3; col < 20; col++){
				product = matrix[row][col] * matrix[row+1][col-1] * matrix[row+2][col-2] * matrix[row+3][col-3];
				if(product > leftDiagonal){
					leftDiagonal = product;
				}
			}
		}
		return leftDiagonal;
	...
	public static void main(String[] args){
		GridProduct grid = new GridProduct();
			System.out.println("Down:" + grid.calculateDown());
			System.out.println("Right:" + grid.calculateRight());
			System.out.println("RightDiagonal:" + grid.calculateRightDiagonal());
			System.out.println("LeftDiagonal:" + grid.calculateLeftDiagonal());
